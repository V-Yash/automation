...
def send_notification(daysToExpiration,hostname):
    ...
    url = "https://hooks.slack.com/(slack channel webhook URL)"
...
hostname = ['google.co.in'] #hostname, can put mutiple hostname in this list
port = '443'
for i in hostname:
    ...
    if daysToExpiration <= 18 or daysToExpiration<= 15: #can change the days accordingly
